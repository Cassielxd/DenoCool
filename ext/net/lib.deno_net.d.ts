...
declare namespace Deno {
  ...
  export interface ListenOptions {
     ...
     * You should show the message like `service running on localhost:8080` instead of
     * `service running on 0.0.0.0:8080` if your program supports Windows.
     *
     * @default {"0.0.0.0"} */
    hostname?: string;
  }
   ...
   *
   * ```ts
   * const lstnr = Deno.listenTls({ port: 443, certFile: "./service.crt", keyFile: "./service.key" });
   * ```
   *
   * Requires `allow-net` permission.
   *
