...
declare namespace Deno {
  ...
  export namespace errors {
    ...
    /**
     * Raised when attempting to open a service listener on an address and port
   ...
   * though some proposed parts of the API which are useful in a service side
  ...
  export const version: {
     ...
     *
     * A version of the TypeScript type checker and language service is built-in
     * to the Deno CLI. */
    typescript: string;
  };
   ...
   * requests on the HTTP service connection.
   *
   * @category HTTP Server */
  export interface HttpConn extends AsyncIterable<RequestEvent> {
    ...
    /** Initiate a service side closure of the connection, indicating to the
   ...
   *
   * Also see the experimental Flash HTTP service {@linkcode Deno.serve} which
  ...
  export interface MXRecord {
    ...
    preference: number;
    /** The service that mail should be delivered to. */
    exchange: string;
  }
