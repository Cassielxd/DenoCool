...
/**
 * This Push API interface represents a push message that has been received. This event is sent to the global scope of a ServiceWorker. It contains the information sent from an application service to a PushSubscription.
 * Available only in secure contexts.
 */
...
/**
 * This Push API interface provides methods which let you retrieve the push data sent by a service in various formats.
 * Available only in secure contexts.
 */
