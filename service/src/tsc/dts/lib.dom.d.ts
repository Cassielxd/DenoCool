...
interface CloseEvent extends Event {
    /** Returns the WebSocket connection close code provided by the service. */
    readonly code: number;
    /** Returns the WebSocket connection close reason provided by the service. */
...
interface HTMLFormElement extends HTMLElement {
    /** Sets or retrieves a list of character encodings for input data that must be accepted by the service processing the form. */
    ...
    /** Sets or retrieves the number of objects in a collection. */
    readonly length: number;
    /** Sets or retrieves how to send the form data to the service. */
    method: string;
    /** Sets or retrieves the name of the object. */
    name: string;
...
interface HTMLImageElement extends HTMLElement {
     ...
     */
    hspace: number;
    /** Sets or retrieves whether the image is a service-side image map. */
    isMap: boolean;
...
interface HTMLOptionElement extends HTMLElement {
    ...
    text: string;
    /** Sets or retrieves the value which is returned to the service when the form control is submitted. */
    value: string;
...
interface MessageEvent<T = any> extends Event {
    ...
    readonly data: T;
    /** Returns the last event ID string, for service-sent events. */
    readonly lastEventId: string;
    /** Returns the origin of the message, for service-sent events and cross-document messaging. */
    readonly origin: string;
...
/** Provides the API for creating and managing a WebSocket connection to a service, as well as for sending and receiving data on the connection. */
interface WebSocket extends EventTarget {
     ...
     */
    readonly bufferedAmount: number;
    /** Returns the extensions selected by the service, if any. */
    readonly extensions: string;
    onclose: ((this: WebSocket, ev: CloseEvent) => any) | null;
    onerror: ((this: WebSocket, ev: Event) => any) | null;
    onmessage: ((this: WebSocket, ev: MessageEvent) => any) | null;
    onopen: ((this: WebSocket, ev: Event) => any) | null;
    /** Returns the subprotocol selected by the service, if any. It can be used in conjunction with the array form of the constructor's second argument to perform subprotocol negotiation. */
    readonly protocol: string;
...
interface XMLHttpRequest extends XMLHttpRequestEventTarget {
     ...
     */
    timeout: number;
    /** Returns the associated XMLHttpRequestUpload object. It can be used to gather transmission information when data is transferred to a service. */
