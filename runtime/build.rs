...
mod startup_snapshot {
  ...
  fn transpile_ts_for_snapshotting(file_source: &ExtensionFileSource) -> Result<ModuleCode, AnyError> {
  ...
  impl deno_fetch::FetchPermissions for Permissions {
    fn check_net_url(&mut self, _url: &deno_core::url::Url, _api_name: &str) -> Result<(), deno_core::error::AnyError> {
      unreachable!("snapshotting!")
    }

    fn check_read(&mut self, _p: &Path, _api_name: &str) -> Result<(), deno_core::error::AnyError> {
      unreachable!("snapshotting!")
    }
  }
  ...
  impl deno_net::NetPermissions for Permissions {
    fn check_net<T: AsRef<str>>(&mut self, _host: &(T, Option<u16>), _api_name: &str) -> Result<(), deno_core::error::AnyError> {
      unreachable!("snapshotting!")
    }
    ...
    fn check_write(&mut self, _p: &Path, _api_name: &str) -> Result<(), deno_core::error::AnyError> {
      unreachable!("snapshotting!")
    }
  }
  ...
  impl deno_fs::FsPermissions for Permissions {
    ...
    fn check_read_blind(&mut self, _path: &Path, _display: &str, _api_name: &str) -> Result<(), AnyError> {
      unreachable!("snapshotting!")
    }
    ...
    fn check_write_blind(&mut self, _path: &Path, _display: &str, _api_name: &str) -> Result<(), AnyError> {
      unreachable!("snapshotting!")
    }
  }
  ...
  deno_core::extension!(
    ...
    customizer = |ext: &mut deno_core::ExtensionBuilder| {
      ext.esm(vec![ExtensionFileSource {
        ...
        code: deno_core::ExtensionFileSourceCode::IncludedInBinary(include_str!("js/99_main.js")),
      }]);
  ...
  pub fn create_runtime_snapshot(snapshot_path: PathBuf) {
    ...
    let extensions: Vec<Extension> = vec![
      ...
      deno_web::deno_web::init_ops_and_esm::<Permissions>(deno_web::BlobStore::default(), Default::default()),
