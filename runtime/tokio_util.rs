...
pub fn create_basic_runtime() -> tokio::runtime::Runtime {
  ...
  tokio::runtime::Builder::new_current_thread()
    ...
    .global_queue_interval(tokio_env("DENO_TOKIO_GLOBAL_QUEUE_INTERVAL", global_queue_interval))
    .max_io_events_per_tick(tokio_env("DENO_TOKIO_MAX_IO_EVENTS_PER_TICK", max_io_events_per_tick))
